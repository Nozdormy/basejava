...
public class DataStreamSerializer implements StreamSerializer {
        ...
        try (DataOutputStream dos = new DataOutputStream(os)) {
            ...
            writeCollection(dos, r.getSections().entrySet(), entry -> {
                ...
                switch (type) {
                    ...
                    case ACHIEVEMENT:
                    case QUALIFICATIONS:
                        writeCollection(dos, ((ListSection) section).getItems(), str -> dos.writeUTF(str));
                        break;
                    case EXPERIENCE:
                    case EDUCATION:
    ...
    private <T> void readItems(DataInputStream dis, ElementProcessor<T> reader) throws IOException {
